...
Tfind= class(TObject)
  ...
  public
    function findtext(fText:string;setText,getText:TStringList):boolean;
  end;
...
function Tfind.findtext(fText:string;setText,getText:TStringList):boolean;
var
  s:Tstringlist;
  s1:string;
  i,i1,i2,i4:integer;
...
begin
  ...
  s.Clear;
  memo:=Tmemo.Create(find_form);
  memo.Visible := false;
  memo.Parent := find_form;
  //function_unit.Show;
