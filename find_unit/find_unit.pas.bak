...
begin
  ...
  if (i < 0) and (listbox1.Items.Count -1 > 0) then begin
    i := 0
...
begin
  {
  MainForm.TabControl1.TabIndex:= strtoint(Memo1.Lines[find_form.TabControl1.TabIndex]);
  aList.LoadFromFile(
        ExtractFilePath( Paramstr(0) ) +
          {ExtractFileName} Memo1.Lines[find_form.TabControl1.TabIndex] + '.lst'
          );
  ListBox1.Items.Text:= aList.Text;
  }
  //showmessage(Memo1.Lines[find_form.TabControl1.TabIndex]);
  if tabclrsw then begin
    tabclrsw := false;
    exit;
  end;
  mainform.PageControl1.PageIndex := strtoint(Memo1.Lines[find_form.TabControl1.TabIndex]);
  ListBox1.Items.Text:= listset[strtoint(memo1.Lines[find_form.TabControl1.TabIndex])].Text;
  ListBox2.Items.Text:= listset2[strtoint(memo1.Lines[find_form.TabControl1.TabIndex])].Text;

  //listallload(strtoint(Memo1.Lines[find_form.TabControl1.TabIndex]));
end;
